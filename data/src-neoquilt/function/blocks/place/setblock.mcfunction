...
#-- ROTATE BLOCKS --#
# read the extends and test for the rotate extend
...
execute if score $isROT neoquilt.blockExtends matches 1 run function src-neoquilt:blocks/place/extends/rotate
